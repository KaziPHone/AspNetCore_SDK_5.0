...
namespace MetricsAgentTests
{
    public class HddMetricsControllerUnitTests
    {
        ...
        private Mock<HddMetricCreateRequest> _mockRequest;
        ...
        public HddMetricsControllerUnitTests()
        {
            ...
            _mockRequest = new Mock<HddMetricCreateRequest>();
            _controller = new HddMetricsController(_mockLogger.Object, _mockRepositore.Object, _mockMapper.Object);
        }
