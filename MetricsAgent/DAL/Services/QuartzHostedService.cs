...
namespace MetricsAgent.DAL.Services
{
    public class QuartzHostedService : IHostedService
    {
        ...
        public QuartzHostedService(
            ICpuMetricsRepository repositoryCpu,
            IRamMetricsRepository repositoryRam,
            IHddMetricsRepository repositoryHdd,
            IDotnetMetricsRepository repositoryDotnet,
            IDotnetMetricsRepository repositoryNetwork,
